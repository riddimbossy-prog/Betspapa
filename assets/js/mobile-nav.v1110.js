  ...
  function start() {
    ...
    document.body.insertAdjacentHTML("beforeend", `
      <nav class="bp-mobile-nav" id="bpMobileNav" aria-label="Mobile navigation">
        ...
        <a href="${link("bankers.html")}" data-bp-tab="bankers" aria-label="Bankers">
      ...
      <div class="bp-mobile-sheet-backdrop" id="bpMobileSheetBackdrop" hidden>
        <section class="bp-mobile-sheet" role="dialog" aria-modal="true" aria-labelledby="bpMobileSheetTitle">
          ...
          <div class="bp-mobile-sheet-grid">
            ...
            <a href="${link("account.html")}"><strong>Account</strong><small>Sign in or manage your profile</small></a>
            <a href="${link("watchlist.html")}"><strong>Watchlist</strong><small>Your saved teams and picks</small></a>
            <a href="${link("settings.html")}"><strong>Notifications</strong><small>Push alerts and quiet hours</small></a>
