(() => {
  ...
  function start() {
    ...
    const active = (() => {
      ...
      if (file === "boss-picks.html" || file === "bankers.html") return "boss";
    ...
    document.body.insertAdjacentHTML("beforeend", `
      <nav class="bp-mobile-nav" id="bpMobileNav" aria-label="Mobile navigation">
        ...
        <a href="${link("boss-picks.html")}" data-bp-tab="boss" aria-label="Papa's Boss Picks">
          <span aria-hidden="true">♛</span><small>Boss Picks</small>
        </a>
