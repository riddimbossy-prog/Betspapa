(() => {
  ...
  const ATHENA_CACHE_PREFIX = "betspapa:athena-board:v1186:";
  ...
  function athenaCard(item) {
    ...
    return `
      <button class="pick-card boss-card athena-card ${item.grade === "PRIME" ? "prime" : "qualified"}" data-fixture="${escapeHtml(item.fixtureId)}">
        ...
        ${switched ? `<small class="athena-arbitration-switch">v1.1.1 replaced the RC1 priority pick with the stronger safe market.</small>` : ""}
