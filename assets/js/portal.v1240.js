(() => {
  ...
  const ENGINE_BOARD_CACHE_PREFIX = "betspapa:prepared-board:v1240:";
  const ENGINE_BOARD_CACHE_MAX_AGE_MS = 3 * 24 * 60 * 60 * 1000;
  const ATHENA_CACHE_PREFIX = "betspapa:athena-board:v1240:";
  const PAPA_HUB_CACHE_PREFIX = "betspapa:papa-hub:v1240:";
